...
/* Заменяем «Лист» → «Рулон» в названиях позиций рулонного хаба. Источник
   ...
   что путает покупателя на странице /rulon-nerzhaveyushchiy/. Если в названии уже есть слово
...
/* Единая точка чтения SKU из прайса: для /list-nerzhaveyushchiy/ выкидывает рулон-стайл,
   для /rulon-nerzhaveyushchiy/ — переименовывает «лист» в «рулон», для /truba-nerzhaveyushchaya/ — конвертирует
...
/* Часть роутов (`/list-nerzhaveyushchiy/[slug].astro`) генерирует страницы из сырого массива
