...
export const gosts: GostItem[] = [
	...
	{ num: '1050-88', title: 'Прокат сортовой, калиброванный со специальной отделкой поверхности из углеродистой качественной конструкционной стали (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/1050-88.pdf', hub: '/krug/' },
	{ num: '1435-99', title: 'Прутки, полосы и мотки из инструментальной нелегированной стали (общие технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/1435-99.pdf', hub: '/krug/' },
	{ num: '14959-79', title: 'Прокат из рессорно-пружинной углеродистой и легированной стали (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/14959-79.pdf', hub: '/krug/' },
	{ num: '19265-73', title: 'Прутки и полосы из быстрорежущей стали (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/19265-73.pdf', hub: '/krug/' },
	{ num: '20072-74', title: 'Сталь теплоустойчивая (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/20072-74.pdf', hub: '/krug/' },
	{ num: '3836-83', title: 'Сталь электротехническая нелегированная тонколистовая и ленты (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/3836-83.pdf', hub: '/list/' },
	{ num: '4405-75', title: 'Сталь полосовая горячекатаная и кованная инструментальная (сортамент)', cat: 'kachestvennyy', pdf: '/gost/pdf/4405-75.pdf', hub: '/polosa/' },
	{ num: '4543-71', title: 'Прокат из легированной конструкционной стали (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/4543-71.pdf', hub: '/krug/' },
	{ num: '5632-72', title: 'Стали высоколегированные и сплавы коррозионно-стойкие, жаростойкие и жаропрочные (марки)', cat: 'kachestvennyy', pdf: '/gost/pdf/5632-72.pdf', hub: '/list/', priority: 'core' },
	/* Действующие ТУ на сортовой нержавеющий прокат (пришёл на смену 5949-75):
	   по нему идут круг, квадрат и шестигранник в каталоге. */
	{ num: '5949-2018', title: 'Металлопродукция из сталей нержавеющих и сплавов на железоникелевой основе коррозионно-стойких, жаростойких и жаропрочных (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/5949-2018.pdf', hub: '/krug/', priority: 'core' },
	{ num: '5950-2000', title: 'Прутки, полосы и мотки из инструментальной легированной стали (общие технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/5950-2000.pdf', hub: '/krug/' },
	{ num: '801-78', title: 'Сталь подшипниковая (технические условия)', cat: 'kachestvennyy', pdf: '/gost/pdf/801-78.pdf', hub: '/krug/' },

	// 2. ЛИСТОВОЙ ПРОКАТ — 14 документов
	{ num: '14637-89', title: 'Прокат толстолистовой из углеродистой стали обыкновенного качества (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/14637-89.pdf', hub: '/list/' },
	{ num: '14918-80', title: 'Сталь тонколистовая оцинкованная с непрерывных линий (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/14918-80.pdf', hub: '/list/' },
	{ num: '1577-93', title: 'Прокат толстолистовой и широкополосный из конструкционной качественной стали (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/1577-93.pdf', hub: '/list/' },
	{ num: '16523-97', title: 'Прокат тонколистовой из углеродистой стали качественной и обыкновенного качества общего назначения (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/16523-97.pdf', hub: '/list/' },
	{ num: '19281-89', title: 'Прокат из стали повышенной прочности (общие технические условия)', cat: 'listovoy', pdf: '/gost/pdf/19281-89.pdf', hub: '/list/' },
	{ num: '19903-74', title: 'Прокат листовой горячекатаный (сортамент)', cat: 'listovoy', pdf: '/gost/pdf/19903-74.pdf', hub: '/list/', priority: 'core' },
	{ num: '19904-90', title: 'Прокат листовой холоднокатаный (сортамент)', cat: 'listovoy', pdf: '/gost/pdf/19904-90.pdf', hub: '/list/', priority: 'core' },
	...
	{ num: '30246-94', title: 'Прокат тонколистовой рулонный с защитно-декоративным покрытием для строительных конструкций (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/30246-94.pdf', hub: '/rulon/' },
	{ num: '4041-71', title: 'Прокат листовой для холодной штамповки из конструкционной качественной стали (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/4041-71.pdf', hub: '/list/' },
	...
	{ num: '5582-75', title: 'Прокат тонколистовой коррозионно-стойкий, жаростойкий и жаропрочный (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/5582-75.pdf', hub: '/list/', priority: 'core' },
	{ num: '7350-77', title: 'Сталь толстолистовая коррозионно-стойкая, жаростойкая и жаропрочная (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/7350-77.pdf', hub: '/list/', priority: 'core' },
	...
	{ num: '9045-93', title: 'Прокат тонколистовой холоднокатаный из низкоуглеродистой качественной стали для холодной штамповки (технические условия)', cat: 'listovoy', pdf: '/gost/pdf/9045-93.pdf', hub: '/list/' },

	// 3. СОРТОВОЙ ПРОКАТ — 20 документов
	{ num: '103-76', title: 'Полоса стальная горячекатаная (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/103-76.pdf', hub: '/polosa/' },
	...
	{ num: '1133-71', title: 'Сталь кованная круглая и квадратная (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/1133-71.pdf', hub: '/krug/' },
	...
	{ num: '2590-88', title: 'Прокат стальной горячекатаный круглый (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/2590-88.pdf', hub: '/krug/' },
	{ num: '2591-88', title: 'Прокат стальной горячекатаный квадратный (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/2591-88.pdf', hub: '/krug/' },
	{ num: '18143-72', title: 'Проволока из высоколегированной коррозионно-стойкой и жаростойкой стали (технические условия)', cat: 'sortovoy', hub: '/provoloka/', priority: 'core' },
	{ num: '30136-95', title: 'Катанка из углеродистой стали обыкновенного качества (технические условия)', cat: 'sortovoy', pdf: '/gost/pdf/30136-95.pdf', hub: '/provoloka/' },
	...
	{ num: '535-2005', title: 'Прокат сортовой и фасонный из стали углеродистой обыкновенного качества (общие технические условия)', cat: 'sortovoy', pdf: '/gost/pdf/535-2005.pdf', hub: '/krug/' },
	...
	{ num: '8509-93', title: 'Уголки стальные горячекатаные равнополочные (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/8509-93.pdf', hub: '/ugolok-shveller/', priority: 'core' },
	{ num: '8510-86', title: 'Уголки стальные горячекатаные неравнополочные (сортамент)', cat: 'sortovoy', pdf: '/gost/pdf/8510-86.pdf', hub: '/ugolok-shveller/', priority: 'core' },
	...
	{ num: '10704-91', title: 'Трубы стальные электросварные прямошовные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/10704-91.pdf', hub: '/truba/' },
	{ num: '10705-80', title: 'Трубы стальные электросварные (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/10705-80.pdf', hub: '/truba/' },
	{ num: '10706-76', title: 'Трубы стальные электросварные прямошовные (технические требования)', cat: 'trubnyy', pdf: '/gost/pdf/10706-76.pdf', hub: '/truba/' },
	{ num: '11068-81', title: 'Трубы электросварные из коррозионно-стойкой стали (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/11068-81.pdf', hub: '/truba/', priority: 'core' },
	{ num: '13663-86', title: 'Трубы стальные профильные (технические требования)', cat: 'trubnyy', pdf: '/gost/pdf/13663-86.pdf', hub: '/truba/' },
	{ num: '30245-03', title: 'Профили стальные гнутые замкнутые сварные квадратные и прямоугольные для строительных конструкций (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/30245-03.pdf', hub: '/truba/' },
	...
	{ num: '8639-82', title: 'Трубы стальные квадратные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/8639-82.pdf', hub: '/truba/' },
	{ num: '8642-68', title: 'Трубы стальные овальные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/8642-68.pdf', hub: '/kalkulyator-ovalnoy-truby/' },
	{ num: '8645-68', title: 'Трубы стальные прямоугольные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/8645-68.pdf', hub: '/truba/' },
	{ num: '8731-87', title: 'Трубы стальные бесшовные горячедеформированные (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/8731-87.pdf', hub: '/truba/' },
	{ num: '8732-78', title: 'Трубы стальные бесшовные горячедеформированные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/8732-78.pdf', hub: '/truba/' },
	{ num: '8733-74', title: 'Трубы стальные бесшовные холоднодеформированные и теплодеформированные (технические требования)', cat: 'trubnyy', pdf: '/gost/pdf/8733-74.pdf', hub: '/truba/' },
	{ num: '8734-75', title: 'Трубы стальные бесшовные холоднодеформированные (сортамент)', cat: 'trubnyy', pdf: '/gost/pdf/8734-75.pdf', hub: '/truba/' },
	{ num: '9940-81', title: 'Трубы бесшовные горячедеформированные из коррозионно-стойкой стали (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/9940-81.pdf', hub: '/truba/', priority: 'core' },
	{ num: '9941-81', title: 'Трубы бесшовные холодно- и теплодеформированные из коррозионностойкой стали (технические условия)', cat: 'trubnyy', pdf: '/gost/pdf/9941-81.pdf', hub: '/truba/', priority: 'core' },
