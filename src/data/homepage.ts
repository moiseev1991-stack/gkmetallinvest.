...
export const longDescription: Array<{ h: string; p: string }> = [
	{
		h: 'Нержавеющая сталь',
	...
	},
	{
		...
		p: 'Покупая нержавеющую сталь, профильные трубы или другие металлопрокатные изделия у ГК Металлинвест, вы получаете надёжного партнёра для вашего бизнеса. Мы готовы выполнить заказы разных объёмов и сложности, обеспечивая своевременную доставку и профессиональное обслуживание. Сделайте правильный выбор — выбирайте ГК Металлинвест!',
	},
];
