...
export const aboutTeaser =
	'Группа компаний Металлинвест — поставки нержавеющего металлопроката и профиля для металлообработки, строительства и промышленности. Помогаем инженерам и закупкам подобрать марку, формат и сроки. Лазерная и гильотинная резка, поставки под проект.';

/** Развёрнутый текст внизу страницы (SEO + смыслы) */
export const longDescription = [
	{
		h: 'Нержавеющая сталь',
		p: 'Нержавеющая сталь — это сплав железа с хромом (от 10,5%), устойчивый к коррозии и агрессивным средам. Применяется в пищевой, химической, нефтегазовой промышленности, в строительстве и архитектуре. Поставляем основные марки AISI 304, 316L, 321, 430 и российские эквиваленты — 08Х18Н10, 12Х18Н10Т, 08Х17.',
	},
	{
		h: 'Профильные трубы',
		p: 'Электросварные профильные трубы прямоугольного и квадратного сечения — основной несущий элемент в металлоконструкциях, мебели, ограждениях и фасадах. Производим под ТЗ заказчика с контролем геометрии и поверхности.',
	},
	{
		h: 'Лазерная и гильотинная резка',
		p: 'Режем лист и сортовой прокат на лазерных и гильотинных установках. Длина реза до 12 м, точность по чертежу. Работаем в рамках комплексной поставки — резка + доставка одной заявкой.',
	},
];
